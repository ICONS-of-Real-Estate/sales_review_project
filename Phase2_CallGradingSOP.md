...
**Decision rule (REVERSED 08/09/2026 — see 3D-bis below):** did the rep deliver **a** framework, the right one for this lead, and tie it to what discovery surfaced? Graded generously for substance (did they convey the idea, in their own words) over reciting exact marketing language. The original rule, kept here for history, was: *did the rep proactively and accurately explain all three components — recruit agents, #1-podcast-in-your-city authority, sell more houses — across the whole call? Each of the three is scored independently; a strong explanation of one does not paper over silence on another.*
...
### 3D-bis. THE framework, not all three (08/09/2026) — reverses 3D's decision rule

Tomás, in the training session with Sean on 08/09/2026, reading a real feedback email out loud:

> "on the framework — it says here, obviously, it doesn't deliver the framework. We're not always going to deliver ALL the frameworks. We're going to deliver THE framework. It can't be something from being the #1 podcast in your city, or selling more houses, or recruiting agents. It's never going to be all of them."

Kris: *"It's gonna be a framework, it's not gonna be all the frameworks."* Tomás: *"All of the frameworks, yeah."*

**What was wrong.** 3D's rule required all three legs, so a rep who correctly picked one angle and delivered it well was marked down on the two they had deliberately left out — and the coaching email said so verbatim. Frank Pirrone's read *"Framework explained: false (missing: recruit agents, #1 podcast in your city, sell more houses)"*: penalised on all three at once, for a job nobody was asking the rep to do. This affected **every rep and every call**, not one rubric variant.

**What the framework actually is.** The right angle is *chosen* for the lead out of what discovery surfaced. Tomás's own worked example on the same call, about a lead running both a loan business and an escrow business: *"the framework is going to depend if he wants to invest more on his loans or invest more on escrows. Because you can probably do the loans statewide. He can't do the escrows statewide."* And on the cost of getting it wrong: *"if you were to go ahead and do the pitch without including Veterans United, you might have missed him — because then he'd think, Sean is actually not considering that I also do home loans, so I'm fine, I don't need the podcast."*

**The new rule.** The three per-leg booleans stay, but they are now a *factual record of what was covered*, not a checklist. `Flag: Framework Explained` is true when the rep delivered at least one angle **and** `framework_matched_to_lead` is true. It is false when nothing was delivered, or when what was delivered was generic — ignoring what discovery surfaced — or plainly wrong for this lead. A call where discovery never established a goal or pain cannot have a matched framework.

**Consequence, stated plainly:** this moves framework scores across the whole history, in both directions. Most reps stop failing this dimension for legs they never needed; a rep who recited all three at a lead they had not actually understood now fails it. `RUBRIC_VERSION` moved to `2026-09-08-the-framework` so `rescoreAllCalls()` re-grades existing rows.

**Still needs Tomás's eye on the prompt wording** (`frameworkRubricPrompt_()`, `Phase2_CallScoring.gs`) before the re-scored numbers are used in a session — the direction is his, the exact phrasing is ours.
