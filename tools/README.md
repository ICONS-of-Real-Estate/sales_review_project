...
This folder backfills Google Drive with transcripts for Sean's and Joana's
recorded sales/QC calls. Each script scans a set of Drive folders for videos
...
at Joana's recordings instead of Sean's.
...
Everything lands back in the same two Drive folders the scripts read from:
